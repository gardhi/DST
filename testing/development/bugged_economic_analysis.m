function [ ecoOutput ] = bugged_economic_analysis( SimParam, BattParam, InvParam, ecoParam, InData, SimOutput)
...
disp('YOU ARE CURRENTLY RUNNING THE BUGGED ECONOMIC ANALYSIS')
    ...
    for iBatt = 1 : SimParam.nBattSteps
        ...
        for k = 1 : ecoParam.plantLifetime
            if k > battOperationalYears
                ...
                battOperationalYears = battOperationalYears ...
                                     + battOperationalYears;         
            end
