...
% Last Modified by GUIDE v2.5 05-Nov-2015 16:19:37
...
set(handles.plot_avg_day,'Value',1)
...
assignin('base','plot_avg_day',get(handles.plot_avg_day,'Value'))
...
% --- Executes on button press in plot_avg_day.
function plot_avg_day_Callback(hObject, eventdata, handles)
% hObject    handle to plot_avg_day (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of plot_avg_day
...
if get(handles.select_all,'Value')
    set(handles.plot_SoC,'Value',1)
    set(handles.plot_power_balance,'Value',1)
    set(handles.plot_avg_day,'Value',1)
    set(handles.disp_avg,'Value',1)
    ...
    set(handles.disp_overprod,'Value',1)
    set(handles.disp_gen_req,'Value',1)
    set(handles.disp_biomass_req,'Value',1)
else
    set(handles.plot_SoC,'Value',0)
    set(handles.plot_power_balance,'Value',0)
    set(handles.plot_avg_day,'Value',0)
    set(handles.disp_avg,'Value',0)
    set(handles.disp_worst_case,'Value',0)
    set(handles.disp_overprod,'Value',0)
    set(handles.disp_gen_req,'Value',0)
    set(handles.disp_biomass_req,'Value',0)
end
