...
lPlantChoiceBtnGroupY = lSimControlTitleY - lPlantChoiceBtnGroupHeight -lMargin;

h.PlantChoiceBtnGroup = uibuttongroup(f,'Title','Generation Strategies',...
                                      'Units','Pixels',...
                                      'Position',[lPresetX, lPlantChoiceBtnGroupY,...
                                      lPresetWidth, lPlantChoiceBtnGroupHeight]);

h.CheckBoxBiomass = uicontrol(h.PlantChoiceBtnGroup, 'String', 'Biomass',...
                             'Units','Pixels', 'Value',str2double(Set.checkBoxBiomass),'Position',  ...
                             [lMargin, lPlantChoiceBtnGroupHeight-2*lMargin-lCheckBoxHeight, ...
                             lCheckBoxWidth, lCheckBoxHeight],...
                             'Style','checkbox');%,'Callback',@checkBoxBiomas_Callback);
...
h.OptimalSolutionChoicesBtnGroup = uibuttongroup(f,...
...
h.LlpConstrainedRadioBtn = uicontrol(h.OptimalSolutionChoicesBtnGroup,...
                             'String', 'LLP Constrained',...
                             'Units','Pixels', ...
                             'Value',str2double(Set.checkBoxBiomass),'Position',  ...
                             [lMargin,lRadioBtnY , ...
                             lCheckBoxWidth, lCheckBoxHeight],...
                             'Style','radiobutton');%,'Callback',@checkBoxBiomas_Callback);
...
lRunAllBtnHeight = 50;
lAllModulesBtnY = lOptimalSolutionChoicesBtnGroupY - lRunAllBtnHeight - 1.5*lMargin;
...
h.RunPlantSimBtn = uicontrol(f, 'Style', 'pushbutton', 'String' , 'Run Plant Simulation',...
                              'Units', 'pixels',...
...
lSolutionExplorerTitleY = lFindOptimalSolutionBtnY ...
...
uicontrol(h.EcoParamPanel,'Style','text','String','Biomass Cost [/kW]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY-lNextRow*9 + lMultiLineAdjust2,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');               
h.BiomassCost = uicontrol(h.EcoParamPanel,'Style','edit','String',Set.biomassCostKw,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY-lNextRow*9,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');           
                
uicontrol(h.EcoParamPanel,'Style','text','String','Biomass System Investment Cost',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY-lNextRow*10 + lMultiLineAdjust3,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');               
h.BiomassSystemInvestmentCost = uicontrol(h.EcoParamPanel,...
                    'Style','edit','String',Set.biomassSystemInvestmentCost,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY-lNextRow*10,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');
                
uicontrol(h.EcoParamPanel,'Style','text','String','Biomass System Operation Cost',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY-lNextRow*11 + lMultiLineAdjust3,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');               
h.biomassSystemOperationCost = uicontrol(h.EcoParamPanel,'Style','edit',...
...
lInvPanelStartY = lInDataPanelY + lInDataPanelHeight;
...
h.BiomassDeliveredText = uicontrol(h.BiomasParamPanel,'Style','text',...
                     'String', 'Biomass Delivered [kW]', ...
                     'Position',[lTextX, lTextY - 2*lNextRow + lMultiLineAdjust2,...
                     lTextWidth, lTextSingleHeight],...
                     'HorizontalAlignment','Left');
h.BiomassDelivered = uicontrol(h.BiomasParamPanel,'Style','edit','String', Set.biomassDeliveredKw,...
                     'Position',[lEditX, lEditY - 2*lNextRow , lEditWidth, lEditHeight]);
                 
h.BiomassDeliveryIntervalText = uicontrol(h.BiomasParamPanel,'Style',...
                     'text','String', 'Intervall of Biomass Delivery [Days]', ...
                     'Position',[lTextX, lTextY - 3*lNextRow + lMultiLineAdjust3,...
                     lTextWidth, lTextSingleHeight],...
                     'HorizontalAlignment','Left');
h.BiomassDeliveryInterval = uicontrol(h.BiomasParamPanel,'Style','edit',...
...
h.GeneratorOutputText = uicontrol(h.BiomasParamPanel,'Style','text','String', 'Generator Output Kw', ...
                     'Position',[lTextX, lTextY - 4*lNextRow + lMultiLineAdjust2,...
                     lTextWidth, lTextSingleHeight],...
                     'HorizontalAlignment','Left');
...
h.StartupDelay = uicontrol(h.BiomasParamPanel,'Style','edit','String', Set.startupDelayHours,...
                     'Position',[lEditX, lEditY - 5*lNextRow, lEditWidth, lEditHeight]);
                 
h.RetryDelayText = uicontrol(h.BiomasParamPanel,'Style','text','String', 'Retry Delay when biomas generation fails', ...
                     'Position',[lTextX, lTextY - 6*lNextRow + lMultiLineAdjust3,...
                     lTextWidth, lTextSingleHeight],...
                     'HorizontalAlignment','Left');
h.RetryDelay = uicontrol(h.BiomasParamPanel,'Style','edit','String', Set.retryDelayHours,...
...
lNpcConstraintPanelHeight = lBattPanelStartY - lInvPanelStartY ;
lLlpConstraintPanelY = lInvPanelStartY;
h.NpcConstraintPanel = uipanel(f,'Title','NPC Optimum Search Constraints',...
                              'Units','pixels',...
                              'Position',[lMargin + lPanelWidth,...
                              lLlpConstraintPanelY,lPanelWidth, lNpcConstraintPanelHeight]);
              
lTextY = lNpcConstraintPanelHeight - lPanelEdge -0.5*lMargin;
lEditY = lTextY + lAlignEditText;
   

uicontrol(h.NpcConstraintPanel,'Style','text','String','NPC Search Acceptance [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');
h.NpcAccept = uicontrol(h.NpcConstraintPanel,'Style','edit','String',Set.npcAccept,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');

uicontrol(h.NpcConstraintPanel,'Style','text','String','NPC start [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY - lNextRow,...
                     lTextWidth,lTextSingleHeight],...
                     'HorizontalAlignment', 'Left');
h.NpcStart = uicontrol(h.NpcConstraintPanel,'Style','edit','String',Set.npcStart,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY - lNextRow,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');
           
uicontrol(h.NpcConstraintPanel,'Style','text','String','NPC stop [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY - lNextRow*2,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');
...
uicontrol(h.NpcConstraintPanel,'Style','text','String','NPC step [%]',...
                    ...
                    'Position',[lTextX,lTextY - lNextRow*3,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');
h.NpcStep = uicontrol(h.NpcConstraintPanel,'Style','edit','String',Set.npcStep,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY - lNextRow*3,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');
...
lLlpConstraintPanelHeight = lPvPanelY - lInvPanelStartY ;
lLlpConstraintPanelY = lInvPanelStartY;
h.LlpConstraintPanel = uipanel(f,'Title','Llp Optimum Search Constraints',...
                              'Units','pixels',...
                              'Position',[lMargin + 2*lPanelWidth,...
                              lLlpConstraintPanelY,lPanelWidth, lLlpConstraintPanelHeight]);
...
uicontrol(h.LlpConstraintPanel,'Style','text','String','LLP Search Acceptance [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY + lMultiLineAdjust2,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');
h.LlpAccept = uicontrol(h.LlpConstraintPanel,'Style','edit','String',Set.llpAccept,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');

uicontrol(h.LlpConstraintPanel,'Style','text','String','LLP start [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY - lNextRow,...
                     lTextWidth,lTextSingleHeight],...
                     'HorizontalAlignment', 'Left');
h.LlpStart = uicontrol(h.LlpConstraintPanel,'Style','edit','String',Set.llpStart,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY - lNextRow,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');
           
uicontrol(h.LlpConstraintPanel,'Style','text','String','LLP stop [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY - lNextRow*2,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');
h.LlpStop = uicontrol(h.LlpConstraintPanel,'Style','edit','String',Set.llpStop,...
                    'Units','pixels',...
                    'Position',[lEditX, lEditY - lNextRow*2,...
                     lEditWidth,lEditHeight],...
                    'HorizontalAlignment','Center');

uicontrol(h.LlpConstraintPanel,'Style','text','String','LLP step [%]',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY - lNextRow*3,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');
...
h.HelpBtn = uicontrol(f,'Style','pushbutton','String','? Help',...
                        ...
                        'Position', [lPresetX, lInvPanelStartY, lPresetWidth, 40]);
...
% Whenever a control is used, the callback function will run.
    function updateIterationTrackerBtn_Callback(src, eventdata)
    ...
    function helpBtn_Callback(src, eventdata)
    ...
    function runPlantSim_Callback(src, eventdata)
    ...
    function runAllModules_Callback(src, eventdata)
        ...
        populate_set
        [SimParam, EcoParam, PvParam, BattParam,...
