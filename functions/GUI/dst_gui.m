...
uicontrol(h.EcoParamPanel,'Style','text','String','Biomass System Yearly Cost',...
                    'Units','pixels',...
                    'Position',[lTextX,lTextY-lNextRow*11 + lMultiLineAdjust3,...
                     lTextWidth,lTextSingleHeight],...
                    'HorizontalAlignment', 'Left');               
h.BiomassSystemYearlyCost = uicontrol(h.EcoParamPanel,'Style','edit',...
                    'String',Set.biomassSystemYearlyCost,...
                    'Units','pixels',...
...
lInvParPanelHeight = lEcoParPanelY - lInvPanelStartY;
...
lBiomasPanelHeight =  360; %lRunSolutionExplorerBtnY - lBiomasPanelY - lMargin;
...
%% PV Parameters Panel
lPvParPanelHeight = lBiomasPanelY - lInvPanelStartY ;
...
% Whenever a control is used, the callback function will run.
    ...
    function runPlantSim_Callback(src, eventdata)
        ...
        if h.CheckBoxBiomass.Value
            ...
            evalin('base',['SimOut = pvbio_plant_simulation(SimParam,' ...
                                                          'PvParam,' ...
                                                          'BattParam,' ...
                                                          'InvParam, '...
                                                          'SimData, '...
...
% edit fields. (Displays the 'Set' struct on the edit fields)
    ...
    function populate_set
        ...
        Set.biomassSystemYearlyCost = h.BiomassSystemYearlyCost.String; 
    ...
    function update_edits
        ...
        h.BiomassSystemYearlyCost.String = Set.biomassSystemYearlyCost;
    ...
    function Set = init_default_set_values
        ...
        Set.biomassSystemYearlyCost = '500';
