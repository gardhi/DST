...
uicontrol(h.InDataPanel,'Style', 'text', 'String', 'Irradiation Data Filename',...
                        'Units', 'pixels', ...
...
uicontrol(h.InDataPanel,'Style', 'text', 'String', 'Temperature Data Filename',...
                        'Units', 'pixels', ...
                        'Position', [lInDataNextColumnX, lLoadProfileDataTextY + lMultiLineAdjust2,...
                                     lInDataTextWidth, lTextSingleHeight],...
                    'HorizontalAlignment','Left');
...
h.HelpBtn = uicontrol(f,'Style','pushbutton','String','Help',...
                        ...
                        'Position', [lMargin, lHelpBtnY, lHelpBtnWidth, lHelpBtnHeight]);
...
% Whenever a control is used, the callback function will run.
    ...
    function simulationOverviw_Callback(src,eventdata)
